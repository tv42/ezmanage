#!/usr/bin/perl -wT
#
# $Id: ezmanage-list-subscribers.cgi,v 1.2 2000/03/21 20:59:22 tv42 Exp $
#
...
sub about() {
  my ($n, $v) = ' $Id: ezmanage-list-subscribers.cgi,v 1.2 2000/03/21 20:59:22 tv42 Exp $ ' =~ m{^.*?Id: (\S+) (\S+) .*};
